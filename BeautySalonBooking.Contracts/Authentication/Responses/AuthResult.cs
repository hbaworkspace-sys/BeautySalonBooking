...
public class AuthResult
{
    ...
    public AuthResult(TokenResponse tokens, UserDto user, UserMenuResponse? userMenus = null)
    {
        IsSuccess = true;
        Error = string.Empty;
        Tokens = tokens;
    ...
    private AuthResult(bool success, string error, TokenResponse? tokens, UserDto? user, UserMenuResponse? userMenus)
    {
        IsSuccess = success;
        Error = error;
        Tokens = tokens;
    ...
    public static AuthResult Success(TokenResponse tokens, UserDto user, UserMenuResponse? userMenus = null)
        => new(true, string.Empty, tokens, user, userMenus);
